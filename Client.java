                            ...
                            SwingUtilities.invokeLater(() -> {
                                if (response.equals("User found")) {
                                    ...
                                    if (option == JOptionPane.YES_OPTION) {
                                        ...
                                        JLabel pastMessages;
                                        try {
                                            writer.write("retrieveMessages");
                                            writer.flush();
                                            writer.write(otherUser);
                                            writer.flush();
                                            String retrievedMessages = reader.readLine();
                                            pastMessages = new JLabel(retrievedMessages);

                                        } catch (Exception f) {
                                            pastMessages = new JLabel("No past messages");
                                        }

                                        

                                        //create a JPanel for sending messages
                                        ...
                                        //add componenets to messagePanel
                                        messagePanel.add(messageLabel, BorderLayout.CENTER);
                                        messagePanel.add(sendMessagePanel, BorderLayout.SOUTH);
                                        messagePanel.add(pastMessages, BorderLayout.NORTH);
